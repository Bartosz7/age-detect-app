...
filenames = next(os.walk("../data/test_data/face_images/", (None, None, [])))[2]

min_neighbors = 4
clasifier = "haarcascade_frontalface_alt_tree.xml"
face_images_path = "../data/test_data/face_images/"
...
for imagePath in filenames:
    ...
    directory = (
        "../data/detections/min_neighbors_" + str(min_neighbors) + "/" + clasifier + "/"
    )
